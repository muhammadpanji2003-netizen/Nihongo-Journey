...
## V5.4 — Clickable Learning Path
- Semua tahap Learning Path sekarang dapat diklik.
- Hiragana dan Katakana memiliki deep link langsung ke tab masing-masing.
- N5, N4, dan N3 membuka halaman level dengan pilihan Vocabulary, Kanji, Grammar, Listening, dan Reading.
- Login tidak diperlukan untuk membuka materi, kuis, atau latihan.
- Login hanya digunakan untuk menyimpan dan menyinkronkan progres online.
- N3 Master sudah memiliki halaman tujuan sementara untuk pengembangan mock test berikutnya.
